...
// Magnetic field evaluation at arbitrary points (cached operators on the TD state)
void thincurr_td_set_bpoints(
    void* tw_ptr, void* state_ptr, int32_t npts, const double* pts_xyz, char* error_str
);

void thincurr_td_eval_bpoints(
    void* tw_ptr, void* state_ptr, int32_t npts, double* Bout_xyz, char* error_str
);
