...
void thincurr_eval_field_points(
    void* tw_ptr, const double* pot, const double* coils, int32_t npts,
    const double* pts, double* field, char* error_str
);

void thincurr_td_eval_field_points(
    void* td_state_ptr, int32_t npts, const double* pts, double* field,
    char* error_str
);
