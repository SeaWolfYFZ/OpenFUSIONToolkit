...
// ThinCurr external time domain control functions
void thincurr_td_init(
    void* tw_ptr, bool direct, double dt, double cg_tol, bool timestep_cn,
    int32_t nstatus, int32_t nplot, void* vec_ic, void* sensor_ptr,
    void* hodlr_ptr, void** state_ptr, char* error_str
);

void thincurr_td_advance(
    void* state_ptr, void* icoil_curr, void* icoil_dcurr, void* pcoil_volt,
    bool save_plot, char* error_str
);

void thincurr_td_finalize(
    void* state_ptr, void* vec_out, char* error_str
);
